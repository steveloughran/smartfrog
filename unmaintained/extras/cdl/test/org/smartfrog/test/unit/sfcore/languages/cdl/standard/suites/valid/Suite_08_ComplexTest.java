...
/**
 */
public class Suite_08_ComplexTest extends TestCase {
    ...
    public static TestSuite suite() {
        return SingleDocumentTestCase.createSuite(Suite_08_ComplexTest.class,
                CddlmConstants.TEST_PACKAGE_CDL_SET_08_COMPLEX,
