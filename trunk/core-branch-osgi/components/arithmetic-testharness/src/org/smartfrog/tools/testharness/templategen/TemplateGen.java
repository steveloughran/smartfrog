...
public class TemplateGen { 
   ...
   * this file is :
   *   <logicalName> <hostname> <sfHome directory>
   *       ....
   *  The first entry is assumed to be the principalDaemon if
   * dynamicLoadingOn is true.
   *
   */
  ...
  void instantiateTemplate(PrintStream out) throws Exception {
    ...
    context.put("numberDaemons", new Integer(numberDaemons));
