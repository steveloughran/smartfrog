...
/**
 * The wrapper factory is used to generate wrapped objects
 * when resources within a SmartFrog system do not implement
 * the Restful interface and are incapable of directly servicing
...
{
	/**
	 * Generates a new instance of the appropriate wrapper class
	 * for the subject and owner specified in the result.
	 *
