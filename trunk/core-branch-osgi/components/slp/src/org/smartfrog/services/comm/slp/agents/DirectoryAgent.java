...
/**
    This class implements ans SLP Directory Agent. A DA is used as a cache for 
    service advertisements, and provides better scalability to the service location protocol.
*/
public class DirectoryAgent implements SlpUdpCallback, SLPMessageCallbacks {
    ...
    */
    ...
    /**
        Listens for incoming UDP packets on the unicast address.
        This is also used for sending replies to messages.
    */
    ...
    */
    ...
    /**
        Creates a DirectoryAgent object.
    ...
    */
    public DirectoryAgent() throws ServiceLocationException {
        try {
            ...
            throw new ServiceLocationException(ServiceLocationException.NETWORK_ERROR,
                                               "DA: Failed to resolve inet address");
        }
    ...
    /**
        Creates a DirectoryAgent object.
        Takes its configuration from the provided properties.
    ...
    */
    ...
    /**
        Called whenever a request with the wrong SLP version is received.
        Currently does nothing but write an entry in the log if logging is 
        switched on.
    */
    ...
    */
    ...
    /**
        Shuts down the DA.
        Sends a DAAdvert to notify other agents that it is going down, and closes
        all sockets.
    */
    public void killDA() {
        bootTime = -1;
