...
public class ServiceAgent extends SLPAgent implements Advertiser {
    ...
    */
    ...
    /**
        Does the actual creation of the SA.
        Uses the values set in the constructors.
    */
    ...
    /**
        ...
        The message should be either DAAdv or SrvAck. If it is not
        one of those, the message is simply ignored.
    ...
    */
    ...
    /**
        Handles incoming DAAdverts.
        The information for the DA will be put into a DAInfo object, which is then 
        added to the list of known DAs. The method also notifies the registration thread
        about the newly discovered DA.
    */
