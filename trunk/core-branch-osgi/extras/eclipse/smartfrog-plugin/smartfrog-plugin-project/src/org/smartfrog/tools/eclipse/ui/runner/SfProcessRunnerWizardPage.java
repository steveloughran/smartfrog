...
public class SfProcessRunnerWizardPage
    extends WizardPage
{
     ...
     */
    public SfProcessRunnerWizardPage(String title, String desc,
    ...
    private Composite createSettingsGroup(Composite parent)
    {
        ...
        mProcessName = new Text(group, SWT.BORDER);
