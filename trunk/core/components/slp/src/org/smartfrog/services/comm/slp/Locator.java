 ...
 * @exception ServiceLocationException if the operation fails.
 */
 ...
 */
  ...
  /**
    Returns the list of scopes supported by the locator.
    In the case where the locator has been configured with no scope list,
