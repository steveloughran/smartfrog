...
/**
    The ServiceLocationManager manages the access to the SLP framework.
    Use this class to obtain a Locator or Advertiser for a given locale.
*/
public class ServiceLocationManager {
    /**
        A vector of Locator objects.
        This vector holds the Locators that have been created through this SLM.
    */
    private static Vector Locators = new Vector();
    /**
        A vector of Advertiser objects.
        This vector holds the Advertisers that have been created throug this SLM.
    */
    private static Vector Advertisers = new Vector();
    /**
        Properties for new Agents.
        The properties defined by this object will be used when creating new
        agents. Changing this has no effect on running agents.
    */
    private static Properties properties = null;
    /**
        The minimum refresh interval to use when refreshing services
        with the DAs.
    */
    private static int min_refresh_interval = 0;
    
    /**
        Returns the minimum refresh interval advertised by all running DAs.
        This method is NOT implemented. (always returns 0)
    */
    ...
    /**
        Returns all scopes supported by the running agents (that we know about).
        Advertisers and Locators into one vector.
    */
    ...
    /**
        This method returns a Locator object to use.
        If a Locator object with the given properties allready exists, the existing locator
        will be returned. If no locator with the given properties exists, a new will be created.
        This method will throw a ServiceLocationException is the creation of a new
        Locator fails.
    ...
    */
    ...
    /**
        This method returns an Advertiser object to use.
        If an Advertiser object with the given properties allready exists, the existing advertiser
        will be returned. If no advertiser with the given properties exists, a new will be created.
        This method will throw a ServiceLocationException is the creation of a new
        Advertiser fails.
    ...
    */
    ...
    /**
        Sets the properties to use for new locators and advertisers.
        This has no effect on allready running objects.
