...
/**
 * This class seeks to encapsulate the necessary information about an HTTP request for use in servicing a request within
 * the SmartFrog REST interface. The {@link HttpServletRequest} class can not be directly transmitted around a SmartFrog
...
public class HttpRestRequest implements Serializable {
    ...
    /**
     * Creates a new <code>HttpRestRequest</code> using the information contained within the
    ...
    /**
     * Returns the context path associated with the currently executing web application. Used in construction of URIs.
     *
     ...
     *
     * @return The textual value of the parameter referenced by the textual name if it exists, <code>null</code>
     *         otherwise.
     */
    ...
    /**
     * Ascertains whether the request desires deep expansion in the creation of XML representations of resources. Currently
     * unused. Associated with the 'expand' request parameter.
     *
    ...
    /**
     * Ascertains whether the request desires transparent following of References within the SmartFrog system. Associated
     * with the 'followReferences' request parameter.
     *
    ...
    /**
     * Ascertains whether the response should be in HTML format or XML format. Associated with the 'responseType' request
     * parameter.
     *
    ...
    /**
     * Returns the URI associated with the specific resource within the SmartFrog system. This URI will contain less
     * information than the full request URI ({@link #getRequestURI}).
     *
     * @return A String containing the URI associated with the targetted SmartFrog resource. Only valid if the root context
     *         is known.
     */
    ...
    /**
     * Identifies the textual name of the target resource for this request. This is the last item specified in the request
     * URI.
     *
    ...
    /**
     * Copies all of the information contained within this object into a J2EE {@link HttpServletRequest} object so that it
     * may be used appropriately for generating a response to the client.
     *
    ...
    /**
     * Constructs a {@link Reference} object from an array of strings for use in resolution. Each entry in the array is
     * converted to a {@link ReferencePart} and added to an overall <code>Reference</code> object.
     *
    ...
    /**
     * Constructs a <code>Reference</code> object using an array of strings but only navigating as far as the specified
     * depth.
     *
     * @param path  A string array whose parts will be used to construct a <code>Reference</code> object.
