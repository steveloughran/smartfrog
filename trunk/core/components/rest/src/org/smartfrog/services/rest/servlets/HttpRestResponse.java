...
/**
 * This class seeks to encapsulate all of the necessary information about an HTTP response to be delievered to a user.
 * This utility class is required due to the unserialisable nature of the HttpServletResponse class in the Enterprise
 * Java API (it contains an output stream). These HTTP rest objects are designed to be safe for network transmission
...
public class HttpRestResponse {
     ...
     *
     * @return A byte array whose raw contents are to be sent to the client under the specified content type and character
    ...
    /**
     * Adds a header name/value pair to this response. Add allows multiple values to be defined for a single named header.
     *
    ...
    /**
     * Sets a header name/value pair to this response and overwrites any existing headers with the same name.
     *
     * @param name  The textual name of the header to be added
     * @param value The value to be associated with the provided name.
     */
    ...
    /**
     * Copies all of the information contained within this object into a J2EE {@link HttpServletResponse} object so that it
     * may be used appropriately for serving the repsonse to a client.
     *
    ...
    /**
     * Utility method used to generate <response ...> xml packets for transmission to the client.
     *
