...
%SFJVM% %SFCMDPARAMETERS% -Dorg.smartfrog.sfcore.processcompound.sfProcessName=rootProcess -Djava.security.policy=C:\sf\checkouts\svn_co\proactive.java.policy org.smartfrog.SFSystem %1 %2 %3 %4 %5 %6 %7 %8 %9
