...
public class LivenessPageChecker implements LivenessPage {
     ...
     */
    public LivenessPageChecker(String protocol, String host, int port, String page)
    ...
    public LivenessPageChecker(String url) throws MalformedURLException {
        targetURL = new URL(url);
    }

    public LivenessPageChecker(URL url) {
        targetURL = url;
    }
