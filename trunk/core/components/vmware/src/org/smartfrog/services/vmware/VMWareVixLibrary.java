...
public interface VMWareVixLibrary extends StdCallLibrary {
     ...
     */
    public static int       VIX_API_VERSION = 1;

    public static class VixHandle {
        public static int   VIX_INVALID_HANDLE = 0;
    }
    ...
    public static class VixHandleType {
        public static int   VIX_HANDLETYPE_NONE = 0,
    ...
    public static class VixPropertyType {
        public static int   VIX_PROPERTYTYPE_ANY = 0,
    ...
    public static class VixPropertyID {
        public static int   VIX_PROPERTY_NONE = 0,
    ...
    public static class VixEventType {
        public static int   VIX_EVENTTYPE_JOB_COMPLETED = 2,
    ...
    public static class VixPowerState {
        public static int   VIX_POWERSTATE_POWERING_OFF = 0x0001,
    ...
    public static class VixToolsState {
        public static int   VIX_TOOLSSTATE_UNKNOWN = 0x0001,
    ...
    public static class VixSupportOptions {
        public static int   VIX_VM_SUPPORT_SHARED_FOLDERS = 0x0001,
     ...
     */
    public static String    VIX_ANONYMOUS_USER_NAME = "__VMware_Vix_Guest_User_Anonymous__",
    ...
    public static class VixMsgSharedFolderOptions {
        public static int   VIX_SHAREDFOLDER_WRITE_ACCESS = 0x04;
    }
