...
public interface HadoopConfiguration extends Remote {
    ...
    /**
     * * <p>The uri can contain 2 special parameters: <tt>$jobId</tt> and <tt>$jobStatus</tt>. Those, if present, are
     * replaced by the job's identifier and completion-status respectively.</p>
     *
     * @see <a href="{@docRoot}/org/apache/hadoop/mapred/JobClient.html#JobCompletionAndChaining">Job Completion and
     *      Chaining</a>
     */
