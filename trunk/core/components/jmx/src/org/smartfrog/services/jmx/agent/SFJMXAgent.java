...
public interface SFJMXAgent extends Remote {
    ...
    public void addAgentNotificationListener(NotificationListener listener) throws RemoteException;

    public void removeAgentNotificationListener(NotificationListener listener) throws RemoteException;
