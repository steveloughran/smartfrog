...
public class ClusterResourceMapper {
    ...
    public static void main (String args[]) {
        ...
        Vector test1 = new Vector(); test1.add(new Integer(4)); test1.add(new Integer(5));
        Vector test2 = new Vector(); test2.add("hello"); test2.add("goodbye");
        ...
        Vector test3 = new Vector(); test3.add(new Integer(4)); test3.add(new Integer(4));
        ...
        Context c1 = new ContextImpl(); c1.put("foo", new Integer(1)); c1.put("bar", new Integer(2));
        Context c2 = new ContextImpl(); c2.put("baz", new Integer(5)); c2.put("foo", new Integer(3)); 
