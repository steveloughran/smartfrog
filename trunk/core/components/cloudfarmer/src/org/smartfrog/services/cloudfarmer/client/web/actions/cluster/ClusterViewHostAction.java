...
public class ClusterViewHostAction extends AbstractClusterAction {
    ...
    public ActionForward execute(ActionMapping mapping,
        ...
        try {
            ...
            return failure(request, mapping, "Failed to view the host :" + e, e);
        }
    }
