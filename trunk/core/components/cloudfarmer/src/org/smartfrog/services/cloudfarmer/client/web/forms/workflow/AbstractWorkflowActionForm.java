 ...
 * workflow actions
 */
public abstract class AbstractWorkflowActionForm extends AbstractMombasaActionForm {

    private String workflowSelected;

    public String getWorkflowSelected() {
        return workflowSelected;
    }

    public void setWorkflowSelected(String workflowSelected) {
