 ...
 */
public class ClusterTerminateNodeAction extends AbstractClusterAction {

    @Override
    protected String getActionName() {
        return "ClusterTerminateNodeAction";
    }
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
        ...
        try {
            ...
            return failure(request, mapping, "Failed to shut down the cluster: " + e, e);
        }
    }
}