...
import org.smartfrog.services.cloudfarmer.client.web.actions.cluster.ClusterRequestAttributes;

/**
 *
 */
public interface AttributeNames extends ClusterRequestAttributes {
    String CLUSTER = "cluster";
    String HADOOP_CLUSTER = "hadoopCluster";

    String WORKFLOWURL = "workflowURL";
    String WORKFLOW_SERVER = "WorkflowServer";
    String REMOTE_DAEMON = "remoteDaemon";
