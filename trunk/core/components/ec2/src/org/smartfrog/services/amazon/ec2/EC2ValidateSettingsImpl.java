 ...
 * Created: 09-Apr-2008
 */
public class EC2ValidateSettingsImpl extends EC2ComponentImpl {
    ...
    public EC2ValidateSettingsImpl() throws RemoteException {
    }
    ...
    private class WorkerThread extends WorkflowThread {
        ...
        private WorkerThread() {
            super(EC2ValidateSettingsImpl.this, true);
        }
