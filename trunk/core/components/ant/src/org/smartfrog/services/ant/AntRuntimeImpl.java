...
public class AntRuntimeImpl extends PrimImpl implements RemoteReferenceResolver, AntRuntime {

    private AntImpl owner;


    public AntRuntimeImpl(AntImpl project) throws RemoteException {
        owner = project;
        sfContext = new ContextImpl();
    }
