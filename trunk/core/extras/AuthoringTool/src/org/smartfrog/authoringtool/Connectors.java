		...
		if(type.getName().equals(OutputDependencyConnectionType.NAME)){
			...
			if(con != null){
				con.setSource(getModel());
					...
					getModel().getConnector_Dependent_Source().add(con);
		...
		if(type.getName().equals(InputDependencyConnectionType.NAME)){
			...
			if(con != null){
				con.setTarget(getModel());
					...
					getModel().getComponent_Depends_On_Connector().add(con);
		...
		if(type.getName().equals(InputDependencyConnectionType.NAME)){
			...
			if(con != null){
				con.setTarget(null);
					...
					getModel().getComponent_Depends_On_Connector().remove(con);
		...
		if(type.getName().equals(OutputDependencyConnectionType.NAME)){
			...
			if(con != null){
				con.setSource(null);
					...
					getModel().getConnector_Dependent_Source().remove(con);
...
public void disconnectOutput(Wire w, boolean modifymodel) {
	...
	public List<String> getRelationshipRoles(){
	   ...
	   roles.add("Connector_Dependent_Source");
	
	    roles.add("Component_Depends_On_Connector");
	...
	public ConnectionType getConnectionTypeForRole(String role){
	    ...
	    if("Connector_Dependent_Source".equalsIgnoreCase(role)){
	       return OutputDependencyConnectionType.INSTANCE;
	    }
	
	    if("Component_Depends_On_Connector".equalsIgnoreCase(role)){
    ...
    public Object getRoleValue(String role){
		...
		if("Child_Connector".equalsIgnoreCase(role)){
	       return getChild_Connector();
	    }
	
		if("Member_Connector".equalsIgnoreCase(role)){
	       return getMember_Connector();
	    }
    ...
    protected void buildContainmentNames() {
    	...
    	roles.add("Child_Connector");
    	
    	roles.add("Member_Connector");
    ...
    public Class getParentForRole(String role){
    	...
    	if("Child_Connector".equals(role)){
    		return Composite.class;
    	}
    	
    	if("Member_Connector".equals(role)){
