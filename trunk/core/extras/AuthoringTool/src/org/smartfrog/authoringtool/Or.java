...
public class Or extends Connectors  implements Adapter, EMFModelObject, org.gems.designer.model.EMFModelElement{

	private org.smartfrog.authoringtool.emf.Or model_;
	private Notifier target_;
	
	public Or(){		
	}
	
	public Or(org.smartfrog.authoringtool.emf.Or model){
		model_ = model;
	...
	public org.smartfrog.authoringtool.emf.Or getModel(){
		if(model_ == null){
			model_ = org.smartfrog.authoringtool.emf.impl.SmartfrogFactoryImpl.eINSTANCE.createOr();
			super.setName(model_.getName());
			model_.eAdapters().add(this);
		}
		return model_;
	...
	public org.smartfrog.authoringtool.emf.Or getExtendedModel(){
		return getModel();
	}
	
	public org.smartfrog.authoringtool.emf.Or getEMFObject(){
		return getModel();
	}
    ...
    public static final IPropertyDescriptor[] OR_ATTRIBUTE_DESCRIPTORS =
    {
    };
    public static final Object[] OR_DEFAULT_ATTRIBUTE_VALUES = {
    ...
    protected void getPropertyDescriptors(Vector desc){
    	desc.addAll(java.util.Arrays.asList(OR_ATTRIBUTE_DESCRIPTORS));    	
...
public void accept(Visitor visitor) {
   if(visitor instanceof SmartfrogVisitor)
   	((SmartfrogVisitor)visitor).visitOr(this);
   else
