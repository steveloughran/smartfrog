 ...
 * <ul>
 *   <li>{@link org.smartfrog.authoringtool.emf.impl.MementoImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.smartfrog.authoringtool.emf.impl.MementoImpl#getData <em>Data</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MementoImpl extends EObjectImpl implements Memento
{
  ...
  {
    return SmartfrogPackage.Literals.MEMENTO;
  }
  ...
  public void setId(String newId)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SmartfrogPackage.MEMENTO__ID, oldId, id));
  }
  ...
  public EList getData()
  {
    if (data == null)
    {
      data = new EObjectContainmentEList(MementoValue.class, this, SmartfrogPackage.MEMENTO__DATA);
    }
    return data;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SmartfrogPackage.MEMENTO__DATA:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SmartfrogPackage.MEMENTO__ID:
        return getId();
      case SmartfrogPackage.MEMENTO__DATA:
        return getData();
    }
