...
public class GemsFactory{
	...
	public Root load(org.smartfrog.authoringtool.emf.Root root){
    	...
    	EList composit = root.getComposit();
    	for(Object obj : composit){
    		getPart(groot,obj);
    	}
    ...
    public ModelObject load(Container root, Object child) {
    	...
    	if(child instanceof org.smartfrog.authoringtool.emf.Composit){
    		return loadComposit(root,(org.smartfrog.authoringtool.emf.Composit)child);
    	}
    	...
    	public Composit loadComposit(Container root, org.smartfrog.authoringtool.emf.Composit obj){
    	   Composit gobj = null;
    	   
    	   gobj = new Composit(obj);  
    	   
    	   loadComposit(root,obj,gobj);
    	   parts_.put(obj,gobj);
    	   if(obj.eResource() != null){
    	     parts_.put(obj.eResource().getURI().toString()+"#"+obj.getId(),gobj);
    	   }
    	...
    	public Composit loadComposit(Container root, org.smartfrog.authoringtool.emf.Composit obj, Composit gobj){
    	   ...
    	   if(root != null)
    		...
    		EList composits = obj.getSuperComposit();
    		for(Object child : composits){
    			loadComposit(gobj,(org.smartfrog.authoringtool.emf.Composit)child);
    		}
    	...
    	public DependencyModel loadDependencyModel(Container root, org.smartfrog.authoringtool.emf.DependencyModel obj, DependencyModel gobj){
    	   ...
    	   if(root != null)
    		...
    		EList composits = obj.getSFModel();
    		for(Object child : composits){
    			loadComposit(gobj,(org.smartfrog.authoringtool.emf.Composit)child);
    		}
