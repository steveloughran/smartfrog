...
public class LocalHostTest extends TaskTestBase {

    public LocalHostTest(String s) {
        super(s);
    }
    ...
    protected String getBuildFile() {
        return "localhost.xml";
    }

    public void testEmpty() {
        expectBuildExceptionContaining("testEmpty", "missing property", LocalHost.ERROR_NO_PROPERTY);
    }
    ...
    public void testHostname() {
        executeTarget("testHostname");
    }
    public void testHostAddress() {
        executeTarget("testHostAddress");
        assertPropertyContains("testHostAddress", ".");
    }
