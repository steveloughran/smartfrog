...
<div class="subTitle"><div class="subTitleIcon"><a href="javascript:showDefAttr()"><img  src="onevoice/images/icon_tray_expand_d.gif" title="Show all editable attributes" width="11" height="11" border="0" alt=""></a></div>Action Parameters</div></caption>
<caption  style="display:none;" id="Collapse">
<div class="subTitle"><div class="subTitleIcon"><a href="javascript:showDefAttr()"><img  src="onevoice/images/icon_tray_contract_u.gif" title="Show only basic attributes" width="11" height="11" border="0" alt=""></a></div>Action Parameters</div></caption>
<caption  style="display:none;" id="None">
<div class="subTitle"><div class=subTitleIcon"><div></div>Action Paramters</div>
</caption>
  <thead>
    <tr class="captionRow"> 
...
%>
	  <tr id='allAttributeSet'>
	      ...
	      Click <img  src="onevoice/images/icon_tray_expand_d.gif" width="11" height="11" border="0" style="background-color:#716B66;" alt=""> to display all parameters.]
	    </td>
          </tr>
<%
	}
