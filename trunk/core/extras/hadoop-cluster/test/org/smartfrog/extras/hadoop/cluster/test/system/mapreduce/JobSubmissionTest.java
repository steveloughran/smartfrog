...
*/
package org.smartfrog.extras.hadoop.cluster.test.system.mapreduce;
...
public class JobSubmissionTest extends HadoopTestBase implements Names {
    ...
    public void testJobSubmission() throws Throwable {
        checkMapRedCluster();
        expectSuccessfulTestRunOrSkip(MR_PACKAGE, "testJobSubmission.sf");
