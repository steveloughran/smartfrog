...
public class Spawn extends CompoundImpl implements Prim{
  ...
  /**
   * During the deploy phase, pick up the following attributes :
   * - sfOffspringDescription : the description of the component to be spawned
   * - sfFamilySize : the number of siblings to launch.
   * - sfDestination : destination component where the description should be deployed.
