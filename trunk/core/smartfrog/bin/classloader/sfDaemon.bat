...
java -Dorg.smartfrog.sfcore.processcompound.sfProcessName=rootProcess -Dorg.smartfrog.codebase=%CODEBASE% -Dorg.smartfrog.iniFile=%SFHOME%\bin\default.ini -Dorg.smartfrog.sfcore.processcompound.sfDefault.sfDefault=%SFHOME%\bin\default.sf org.smartfrog.SFSystem %1 %2 %3 %4 %5 %6 %7 %8 %9
