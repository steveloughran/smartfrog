 ...
 */
public class SmartFrogPlaceResolutionException extends
                                               SmartFrogPhaseResolutionException {
    /** String name for resolution phase. */
    { RESOLUTION_PHASE = "place resolution"; }
     ...
     */
    public SmartFrogPlaceResolutionException(String message) {
        super(message);
    }
     ...
     */
    public SmartFrogPlaceResolutionException (String message, Throwable cause, Reference source, Object data) {
     ...
     * @param cause exception causing this exception
     */
    public SmartFrogPlaceResolutionException(Throwable cause) {
        super(cause);
    }
    ...
    public static SmartFrogException forward (Throwable thr){
        if (thr instanceof SmartFrogPlaceResolutionException) {
            return (SmartFrogPlaceResolutionException)thr;
        } else {
            return new SmartFrogPlaceResolutionException (thr);
        }
    }
}
