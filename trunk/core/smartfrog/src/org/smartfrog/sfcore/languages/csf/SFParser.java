...
//              MessageKeys.MSG_INVOCATION_TARGET, includeHandlerClassName), intarexcp);
    ...
    /**
     * Parses a reference from a Reader.
     *
     *@param  reader                  reader to parse
    ...
    /**
     * Parses any value (ie as allowed in an attribute definition) from  a Reader..
     *
     *@param  reader                  reader to parse
     * @return parsed value
    ...
    /**
     * Parses any primtiive value (ie no links, component descriptions) from  a Reader.
     *
     *@param  reader                  reader to parse
     * @return parsed value
   ...
   public Object sfParseTags(Reader reader) throws SmartFrogParseException {
       try {
           return (new org.smartfrog.sfcore.languages.csf.DefaultParser(reader, null)).TagsSet();
       } catch (ParseException pe){
