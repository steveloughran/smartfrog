...
/**
 * MultiCast Server Interface. Defines names of all the attributes required by
 * this component.
 */
public interface SFMCastServer {
    ...
    /** String name for optional attribute "mcastAddress" */
   ...
   /** String name for optional attribute "mcastPort" */
    ...
    /** String name for optional attribute "mcastAddress" */
    final static String ATR_ONLYINROOT = "onlyInRoot";
