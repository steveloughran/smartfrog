...
public class Display extends JFrame implements ActionListener, KeyListener {
   ...
   public void cleanAddedPanels() {
      try {
         ...
         this.tabPane.add(output, "output");
      } catch (Exception ex) {
      }
   }
   ...
   void startMngConsole() {
      ...
      try {
         ...
         startConsole(nameDisplay,
               height, width, positionDisplay, showRootProcess, hostName,
               port, false);
      } catch (java.net.UnknownHostException uex) {
         if (mngConsole != null) {
            mngConsole.dispose();
 ...
 */
class Display_jMenuItemInfo_actionAdapter
       implements java.awt.event.ActionListener {
 ...
 */
class Display_jMenuItemCleanAll_actionAdapter
       implements java.awt.event.ActionListener {
 ...
 */
class Display_jMenuItemSaveAs_actionAdapter
       implements java.awt.event.ActionListener {
 ...
 */
class Display_documentScreen_documentAdapter
 ...
 */
class Display_this_windowAdapter extends java.awt.event.WindowAdapter {
 ...
 */
class Display_jMenuItemInfoProp_actionAdapter
       implements java.awt.event.ActionListener {
 ...
 */
class Display_jMenuItemProcessComp_actionAdapter
       implements java.awt.event.ActionListener {
