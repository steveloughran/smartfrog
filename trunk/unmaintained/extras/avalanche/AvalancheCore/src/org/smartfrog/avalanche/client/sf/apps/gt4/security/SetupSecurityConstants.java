 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SetupSecurityConstants {
	public static String gridSecurityDir = "/etc/grid-security";
	public static String certificateDir = gridSecurityDir + 
			File.separatorChar + "certificates";
	public static String openssl = "openssl";
	public static String subjectStart = "subject= ";
	
	public static String signingPolicyTmpl = 
		"/org.smartfrog/avalanche/client/sf/apps/gt4/setupSecurity/" +
	...
	public static String hostCertReq = gridSecurityDir + 
				File.separatorChar + "hostcert_request.pem";
	public static String hostCert = gridSecurityDir + 
				File.separatorChar + "hostcert.pem";
	public static String hostKey = gridSecurityDir + 
				File.separatorChar + "hostkey.pem";
	
	public static String gridMapFile = gridSecurityDir +
				File.separatorChar + "grid-mapfile";
	
	public static String containerKey = gridSecurityDir +
				File.separatorChar + "containerkey.pem";
	public static String containercert = gridSecurityDir +
				File.separatorChar + "containercert.pem";
