...
public void disconnectOutput(Wire w, boolean modifymodel) {
    ...
    public Object getRoleValue(String role){
		...
		if("Model_Member_Composites".equalsIgnoreCase(role)){
	       return getModel_Member_Composites();
	    }
		...
		if("Composite_Component_Container".equalsIgnoreCase(role)){
	       return getComposite_Component_Container();
	    }
	
		if("Composite_Attribute_Container".equalsIgnoreCase(role)){
	       return getComposite_Attribute_Container();
	    }
	
		if("Composite_Connector_Container".equalsIgnoreCase(role)){
    ...
    protected void buildContainmentNames() {
        	...
        	containmentNames_.put(Component.class,"Composite_Component_Container");
        	containmentNames_.put("Composite_Component_Container",Component.class);
        	childContainmentNames_.put(Component.class,"Child_Components");
        	containmentNames_.put(Attribute.class,"Composite_Attribute_Container");
        	containmentNames_.put("Composite_Attribute_Container",Attribute.class);
        	childContainmentNames_.put(Attribute.class,"Composite_Arrtibute");
        	containmentNames_.put(Connectors.class,"Composite_Connector_Container");
        	containmentNames_.put("Composite_Connector_Container",Connectors.class);
        	childContainmentNames_.put(Connectors.class,"Child_Connector");
    }
    	...
    	roles.add("Model_Member_Composites");
    ...
    public Class getParentForRole(String role){
    	...
    	if("Model_Member_Composites".equals(role)){
   ...
   if(visitor instanceof SmartfrogVisitor)
    ...
    public void addChild(LogicElement child, int index, boolean modifymodel) {
    	  ...
    	  if(child instanceof Component){
    		...
    		getModel().getComposite_Component_Container().add(ceobj);
    		ceobj.setChild_Components(getModel());
    	  }
    	
    	  if(child instanceof Attribute){
    	    org.smartfrog.authoringtool.emf.Attribute ceobj = ((Attribute)child).getEMFObject();
    		getModel().getComposite_Attribute_Container().add(ceobj);
    		ceobj.setComposite_Arrtibute(getModel());
    	  }
    	
    	  if(child instanceof Connectors){
    	    org.smartfrog.authoringtool.emf.Connectors ceobj = ((Connectors)child).getEMFObject();
    		getModel().getComposite_Connector_Container().add(ceobj);
    		ceobj.setChild_Connector(getModel());
    	  }
    ...
    public void removeChild(LogicElement child, boolean modifymodel){
    	...
    	if(child instanceof Component){
    	    org.smartfrog.authoringtool.emf.Component ceobj = ((Component)child).getEMFObject();
    		getModel().getComposite_Component_Container().remove(ceobj);
    		ceobj.setChild_Components(null);
    	}
    	
    	if(child instanceof Attribute){
    	    org.smartfrog.authoringtool.emf.Attribute ceobj = ((Attribute)child).getEMFObject();
    		getModel().getComposite_Attribute_Container().remove(ceobj);
    		ceobj.setComposite_Arrtibute(null);
    	}
    	
    	if(child instanceof Connectors){
    	    org.smartfrog.authoringtool.emf.Connectors ceobj = ((Connectors)child).getEMFObject();
    		getModel().getComposite_Connector_Container().remove(ceobj);
    		ceobj.setChild_Connector(null);
    	}
