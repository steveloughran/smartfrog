 ...
 */
public class Soap12MustUnderstandHeaderTest extends ValidTestBase {

    public Soap12MustUnderstandHeaderTest(String name) {
        super(name);
    }
    ...
    protected String getTestResource() {
        return SOAP12_MUST_UNDERSTAND_HEADER;
    }
}
