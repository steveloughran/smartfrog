...
/**
    This class is used to store information about DAs.
    It is used by Service and User Agents to store a list of available DAs.
*/
class DAInfo {
    /**
    ...
    */
    private String host;
    /**
        The port the DA listens to.
        This should in most cases be the default SLP port.
    */
    private int port;
    /**
