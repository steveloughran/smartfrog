...
/**
    Defines the methods used to handle incoming requests.
    All agents implement these.
*/
public interface SLPMessageCallbacks {
    /**
        Called whenever request that is not a reply is received.
        These are: SrvReq, SrvTypeReq, SrvReg, SrvDeReg.
    ...
    */
    ...
    /**
        Called whenever a reply to a request is received.
        Replies can be: SrvRply, SrvTypeRply, SrvAck.
        @param function The type of message received.
        @param sis The SLPInputStream to read the message from.
