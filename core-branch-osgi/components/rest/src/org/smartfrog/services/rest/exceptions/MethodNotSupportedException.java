...
/**
 * This exception is thrown when an unsupported HTTP
 * operation is requested upon a specific resource. It
 * is intended this exception will yield the transmission
 * of an HTTP 405 response to the client along with a
 * meaningful explanation of why the error occured.
 *
