 ...
 */
public class SmartFrogAssertionResolutionException extends
                                               SmartFrogFunctionResolutionException {
    /** String name for resolution phase. */
    { RESOLUTION_PHASE = "assertion or schema evaluation or construction"; }
     ...
     */
    public SmartFrogAssertionResolutionException(String message) {
        super(message);
    }
     ...
     */
    public SmartFrogAssertionResolutionException (String message, Throwable cause, Reference source, Object data) {
     ...
     * @param cause exception causing this exception
     */
    public SmartFrogAssertionResolutionException(Throwable cause) {
        super(cause);
    }
