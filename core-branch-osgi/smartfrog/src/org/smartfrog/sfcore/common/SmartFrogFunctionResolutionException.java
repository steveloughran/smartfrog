 ...
 */
public class SmartFrogFunctionResolutionException extends
                                               SmartFrogPhaseResolutionException {
    /** String name for resolution phase. */
    { RESOLUTION_PHASE = "function evaluation or construction"; }
     ...
     */
    public SmartFrogFunctionResolutionException(String message) {
        super(message);
    }
     ...
     */
    public SmartFrogFunctionResolutionException (String message, Throwable cause, Reference source, Object data) {
     ...
     * @param cause exception causing this exception
     */
    public SmartFrogFunctionResolutionException(Throwable cause) {
        super(cause);
    }
    ...
    public static SmartFrogException forward (Throwable thr){
        if (thr instanceof SmartFrogFunctionResolutionException) {
            return (SmartFrogFunctionResolutionException)thr;
        } else {
            return new SmartFrogFunctionResolutionException (thr);
        }
    }
}
