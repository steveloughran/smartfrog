...
/**
 *
 * Created 03-Apr-2008 16:51:05
 *
 */

public class WorkflowThreadTest extends DeployingTestBase {

    public static final String PACKAGE="/org/smartfrog/test/system/workflow/thread/";

    public WorkflowThreadTest(String name) {
        super(name);
    }
