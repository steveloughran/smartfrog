...
/** Tests that the classpath logic works created 19-Jun-2007 15:00:55 */

public class ClasspathTest extends SmartFrogTestBase {
    ...
    public void testRecursiveClasspath() throws Throwable {
        application = deployExpectingSuccess(FILES +
                "testRecursiveClasspath.sf", "testRecursiveClasspath");
    }
}
