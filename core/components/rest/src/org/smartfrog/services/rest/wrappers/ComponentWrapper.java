...
/**
 * The component wrapper is used to encapsulate {@link ComponentDescription} and {@link Prim} objects and their
 * descendants.
 *
        ...
        try {
            ...
            if (resourceRequest.getTargetType().equals("description")) {
                ...
                if (result.ownerIsRoot()) {
                    ...
                    rootProcess.sfCreateNewChild(restRequest.getTargetResourceName(),
                            (Prim) result.getOwner(),
                            description,
                            null);
                    response = HttpRestResponse.generateResponseXML("OK", "The component was successfully deployed" +
