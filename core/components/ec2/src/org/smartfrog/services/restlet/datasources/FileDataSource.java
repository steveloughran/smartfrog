 ...
 *
 */
public class FileDataSource extends AbstractRestletDataSource implements RestletDataSource,
        FileUsingComponent {
    ...
    public FileDataSource() throws RemoteException {
    }
    ...
    public synchronized void sfStart()
        ...
        timeToLive = sfResolve(ATTR_TIME_TO_LIVE,0,true)/1000;
    }
    ...
    public Representation loadRepresentation()
            throws SmartFrogException, RemoteException {
        return new FileRepresentation(file, getMediaType(), timeToLive);
    }
}
