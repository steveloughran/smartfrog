 ...
 */
public class S3Bucket extends S3Resource {

    private String name;

    private boolean truncated;

    public S3Bucket(String awsID, String secretKey, String name) {
     ...
     * 
     * @return The objects in this bucket.
     */
    ...
    /**
     * Get the URI for this bucket
     * @return the derived bucket URI
     */
