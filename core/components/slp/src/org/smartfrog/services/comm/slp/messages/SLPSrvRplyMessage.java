...
public class SLPSrvRplyMessage extends SLPMessageHeader {
    ...
    */
    ...
    /**
        Creates a SLPSrvRplyMessage with the given contents.
        If the message is too large to fit inside a datagram, the overflow
        flag is set, and the remaining URLs left out.
    ...
    */
    public void toOutputStream(SLPOutputStream stream) throws ServiceLocationException {       
        ...
        try {
            ...
            if(errorCode != 0)stream.writeShort(0); // num urls
            else {
