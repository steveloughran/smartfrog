...
/**
    Implements a database entry for a service.
    This holds all the attributes that are stored in the database.
*/
class SLPDatabaseEntry {
    ...
    */
    public SLPDatabaseEntry(ServiceURL url, Vector attributes, Vector scopes, Locale locale) {
        ...
        if(scopes != null) this.scopes = (Vector)scopes.clone();
        else this.scopes = null;
        this.locale = locale;
    ...
    */
    ...
    /**
        Returns the full lifetime of the service.
        This does not take into account that some time has passed since the
...
/**
    Implements a simple database of services.
    This is currently implemented by a linked list.
*/
class SLPDatabase {
    /** 
    ...
    */
    ...
    /**
        Removes the entries for a given ServiceURL from the database.
        The URL is removed in all languages.
    ...
    */
    ...
    /**
        Returns a Vector containing all Service Types that match the given 
        naming authority.
        If na is null: all service types are returned.
        If na is an empty string: all servicetypes with the default (IANA) 
        naming authority are returned.
    ...
    */
    private boolean serviceTypeMatch(SLPDatabaseEntry e, ServiceType type) {
        ...
        if(eType.equals(type))areEqual = true;
