...
package org.smartfrog.services.json.log.test;
...
import org.smartfrog.services.json.log.Log4Json;
...
public class Log4JsonTest extends TestCase {

  private static final Log LOG = LogFactory.getLog(Log4JsonTest.class);
