...
public class EclipseSolver extends CoreSolver implements Runnable, QueueListener {
     ...
     * installation
     */
    static final String ECLIPSE_SWITCH = "/smartfrog/";
    ...
    public EclipseSolver() throws SmartFrogRuntimeException {
        try {
            ...
            SFSystem.sfLog().debug("EXCEPTION:  "+e);
            throw e;
        }
    }
    ...
    private void prepareSolver() throws SmartFrogResolutionException {
        ...
        eclipseDir = System.getProperty(ECLIPSEDIR_SPECIFIER);
        if (eclipseDir == null) {
    ...
    public void addUndoPut(Context ctxt, Object key, Object value) {
        ...
        SFSystem.sfLog().debug("key:"+key+", value"+value);
    ...
    public void dataAvailable(Object source) {
        ...
        SFSystem.sfLog().debug("FUNCTOR: "+func);
