 ...
 */
public class TelnetWindowsTest
    extends DeployingTestBase {

    private static final String FILES = "org/smartfrog/test/system/components/net/";

    public TelnetWindowsTest(String s) {
        super(s);
    }

    public void testWindowsTelnet() throws Throwable {
        expectSuccessfulTestRunOrSkip(FILES, "testWindowsTelnet");
    }
