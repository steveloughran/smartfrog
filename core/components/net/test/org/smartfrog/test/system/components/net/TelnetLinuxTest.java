 ...
 */
public class TelnetLinuxTest
    extends DeployingTestBase {

    private static final String FILES = "org/smartfrog/test/system/components/net/";

    public TelnetLinuxTest(String s) {
        super(s);
    }

    public void testLinuxTelnet() throws Throwable {
        expectSuccessfulTestRunOrSkip(FILES, "testLinuxTelnet");
    }
