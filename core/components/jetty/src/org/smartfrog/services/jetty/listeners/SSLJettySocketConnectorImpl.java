...
/**
 * Extension of the socket class to provide TLS/SSL security Created 08-Oct-2007 15:21:43
 */
...
public class SSLJettySocketConnectorImpl extends JettySocketConnectorImpl implements SSLJettySocketConnector {
    ...
    /**
     * Override the base class and create a socket with SSL/TLS all set up; including keystore and password.
     *
