...
/*
      imageRun = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("ExecuteProject.gif"));
      imageStop = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("Stop.gif"));
      imageKill = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("Hide.gif"));
      imageRunAll = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("RunAll.gif"));
      imageOpen = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("OpenArrow.gif"));
      imageSaveAll = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("SaveAll.gif"));
      imageKillAll = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("KillAll.gif"));
      imageAdd = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("UpdateRow.gif"));
      imageDelete = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("DeleteRow.gif"));
      imageRefresh = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("NewSheet.gif"));
      imagePreferences = new ImageIcon(com.hp.sfTools.gui.browser.MainFrame.class.getResource("Options.gif"));
...
//      this.mngProcess.loadIniFile();
   ...
   public MngProcess getMngProcess(){
      return this.mngProcess;
   }
