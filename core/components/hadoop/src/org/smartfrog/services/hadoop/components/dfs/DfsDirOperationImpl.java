 ...
 *
 */
public class DfsDirOperationImpl extends DfsOperationImpl implements DfsDirOperation {

    private String dir;
    private Path path;
    private boolean idempotent;

    public DfsDirOperationImpl() throws RemoteException {
    }
