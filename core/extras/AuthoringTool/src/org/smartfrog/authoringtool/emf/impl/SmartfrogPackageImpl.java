...
public class SmartfrogPackageImpl extends EPackageImpl implements SmartfrogPackage
{
   ...
   * @generated
   */
  private EClass compositEClass = null;
   ...
   * @generated
   */
  public EReference getComposit_SuperComposit()
  {
    return (EReference)compositEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getComposit_Components()
  {
    return (EReference)compositEClass.getEStructuralFeatures().get(1);
  }
   ...
   * @generated
   */
  public EReference getComposit_Compos()
  {
    return (EReference)compositEClass.getEStructuralFeatures().get(2);
  }
   ...
   * @generated
   */
  public EReference getComposit_Compo()
  {
    return (EReference)compositEClass.getEStructuralFeatures().get(3);
  }
   ...
   * @generated
   */
  public EReference getComposit_ChileComposit()
  {
    return (EReference)compositEClass.getEStructuralFeatures().get(4);
  }
   ...
   * @generated
   */
  public EReference getComposit_Composits()
  {
    return (EReference)compositEClass.getEStructuralFeatures().get(5);
  }
   ...
   * @generated
   */
  public EReference getRoot_Composit()
  {
  ...
  public void createPackageContents()
  {
    ...
    compositEClass = createEClass(COMPOSIT);
    createEReference(compositEClass, COMPOSIT__SUPER_COMPOSIT);
    createEReference(compositEClass, COMPOSIT__COMPONENTS);
    createEReference(compositEClass, COMPOSIT__COMPOS);
    createEReference(compositEClass, COMPOSIT__COMPO);
    createEReference(compositEClass, COMPOSIT__CHILE_COMPOSIT);
    createEReference(compositEClass, COMPOSIT__COMPOSITS);
    ...
    createEReference(rootEClass, ROOT__COMPOSIT);
  ...
  public void initializePackageContents()
  {
    ...
    compositEClass.getESuperTypes().add(this.getModelObject());
    ...
    initEReference(getComponent_Group_of_components(), this.getComposit(), null, "Group_of_components", null, 0, 1, Component.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(compositEClass, Composit.class, "Composit", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getComposit_SuperComposit(), this.getComposit(), null, "SuperComposit", null, 0, 2000, Composit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComposit_Components(), this.getComponent(), null, "Components", null, 0, 2000, Composit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComposit_Compos(), this.getAttribute(), null, "Compos", null, 0, 2000, Composit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComposit_Compo(), this.getConnectors(), null, "Compo", null, 0, 2000, Composit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComposit_ChileComposit(), this.getComposit(), null, "ChileComposit", null, 0, 1, Composit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getComposit_Composits(), this.getDependencyModel(), null, "Composits", null, 0, 1, Composit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getDependencyModel_SFModel(), this.getComposit(), null, "SFModel", null, 0, 2000, DependencyModel.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getAttribute_Composite_arrtibutes(), this.getComposit(), null, "Composite_arrtibutes", null, 0, 1, Attribute.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(connectorsEClass, Connectors.class, "Connectors", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getConnectors_DepConnector(), this.getComposit(), null, "DepConnector", null, 0, 1, Connectors.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getRoot_Composit(), this.getComposit(), null, "Composit", null, 0, 2000, Root.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
