...
public class And extends Connectors  implements Adapter, EMFModelObject, org.gems.designer.model.EMFModelElement{

	private org.smartfrog.authoringtool.emf.And model_;
	private Notifier target_;
	
	public And(){		
	}
	
	public And(org.smartfrog.authoringtool.emf.And model){
		model_ = model;
	...
	public org.smartfrog.authoringtool.emf.And getModel(){
		if(model_ == null){
			model_ = org.smartfrog.authoringtool.emf.impl.SmartfrogFactoryImpl.eINSTANCE.createAnd();
			super.setName(model_.getName());
			model_.eAdapters().add(this);
		}
		return model_;
	...
	public org.smartfrog.authoringtool.emf.And getExtendedModel(){
		return getModel();
	}
	
	public org.smartfrog.authoringtool.emf.And getEMFObject(){
		return getModel();
	}
    ...
    public static final IPropertyDescriptor[] AND_ATTRIBUTE_DESCRIPTORS =
    {
    };
    public static final Object[] AND_DEFAULT_ATTRIBUTE_VALUES = {
    ...
    protected void getPropertyDescriptors(Vector desc){
    	desc.addAll(java.util.Arrays.asList(AND_ATTRIBUTE_DESCRIPTORS));    	
...
public void accept(Visitor visitor) {
   if(visitor instanceof SmartfrogVisitor)
   	((SmartfrogVisitor)visitor).visitAnd(this);
   else
