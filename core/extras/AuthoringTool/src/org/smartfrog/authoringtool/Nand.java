...
public class Nand extends Connectors  implements Adapter, EMFModelObject, org.gems.designer.model.EMFModelElement{

	private org.smartfrog.authoringtool.emf.Nand model_;
	private Notifier target_;
	
	public Nand(){		
	}
	
	public Nand(org.smartfrog.authoringtool.emf.Nand model){
		model_ = model;
	...
	public org.smartfrog.authoringtool.emf.Nand getModel(){
		if(model_ == null){
			model_ = org.smartfrog.authoringtool.emf.impl.SmartfrogFactoryImpl.eINSTANCE.createNand();
			super.setName(model_.getName());
			model_.eAdapters().add(this);
		}
		return model_;
	...
	public org.smartfrog.authoringtool.emf.Nand getExtendedModel(){
		return getModel();
	}
	
	public org.smartfrog.authoringtool.emf.Nand getEMFObject(){
		return getModel();
	}
    ...
    public static final IPropertyDescriptor[] NAND_ATTRIBUTE_DESCRIPTORS =
    {
    };
    public static final Object[] NAND_DEFAULT_ATTRIBUTE_VALUES = {
    ...
    protected void getPropertyDescriptors(Vector desc){
    	desc.addAll(java.util.Arrays.asList(NAND_ATTRIBUTE_DESCRIPTORS));    	
...
public void accept(Visitor visitor) {
   if(visitor instanceof SmartfrogVisitor)
   	((SmartfrogVisitor)visitor).visitNand(this);
   else
