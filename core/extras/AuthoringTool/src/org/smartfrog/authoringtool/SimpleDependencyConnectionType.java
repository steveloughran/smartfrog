...
new org.eclipse.ui.views.properties.TextPropertyDescriptor("Enabled","Enabled")
            ...
            ,
new org.eclipse.ui.views.properties.TextPropertyDescriptor("Dependency_Name","Dependency_Name")
    ...
    private SimpleDependencyConnectionType() {
        super(NAME,Component.class,Component.class,"Simple_Dependent_Source","Simple_Depend_On");
    ...
    public static String getDependency_Name(Wire w){
    	return (String)w.getAttribute(DEPENDENCY_NAME);
    }
}
