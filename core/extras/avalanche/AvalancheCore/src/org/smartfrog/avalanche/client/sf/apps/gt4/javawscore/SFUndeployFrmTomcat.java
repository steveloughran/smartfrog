 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class SFUndeployFrmTomcat extends PrimImpl implements Prim {
	 ...
	 */
	public SFUndeployFrmTomcat() throws RemoteException {
		super();
