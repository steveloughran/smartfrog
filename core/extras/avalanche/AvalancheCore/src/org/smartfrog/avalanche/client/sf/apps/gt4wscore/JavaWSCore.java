...
public class JavaWSCore {
	 ...
	 * @return
	 */
	public boolean buildJavaWSFromSource(Properties props) throws BuildException
	{
		...
		antRunner.runAntTarget(bFile, "all", props);
			...
			log.error("Failed to install Java WS Core");
	...
	public static void main(String args[]) {
		...
		try {
			wscore.buildJavaWSFromSource(null);
