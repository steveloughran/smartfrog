 ...
 * TODO 
 */
public class SFGunzip extends PrimImpl implements Prim {
	public static String ZIPFILE = "gzipFile";
	 ...
	 */
	public SFGunzip() throws RemoteException {
		super();
	}
	...
	public synchronized void sfStart() throws SmartFrogException, RemoteException {
		...
		sfLog().info("Starting uncompressing file : " + file + ", in  : " + dir);
		try{
			ZipUtils.gunzip(file, dir);
