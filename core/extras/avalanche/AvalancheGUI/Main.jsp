...
<table border="0" cellpadding="0" cellspacing="0" width="100%" class="applicationMastheadLarge">
        <tr>
                <td class="mastheadIcon" width="42"><img src="images/frog.gif" width="40" height="40" border="0" alt="HP"></td>
        ...
        <input type="hidden" id="subtitle_next" name="subtitle_next" value=""></td>
                <td width="307"><div class="mastheadPhoto" style="padding-right:0px;"><img src="images/group.png" width="157" height="57" border="0" alt=""></div></td>
        </tr>
</table>
