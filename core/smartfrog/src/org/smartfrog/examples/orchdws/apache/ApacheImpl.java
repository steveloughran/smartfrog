...
import org.smartfrog.examples.orchdws.balancer.ServerInstance;
...
public class ApacheImpl extends CompoundImpl implements Compound, Apache,
    ...
    public synchronized void sfTerminateWith(TerminationRecord tr) {
        ...
        try{ setApacheState(false); } catch(RemoteException re){/*Shouldn't happen*/}
        terminated = true;
     ...
     */
    public synchronized void setApacheState(boolean newState) throws RemoteException{
        ...
        try {
            synchronized (this) {
                ...
                if (!getApacheState()) {
                    ...
                    ServerInstance si = (ServerInstance) ApacheImpl.this.sfResolve(SFSERVERINSTANCE);
                    si.switchToDown();
