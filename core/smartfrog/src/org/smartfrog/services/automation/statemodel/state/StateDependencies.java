...
public interface StateDependencies extends Remote {
    public void register(RelationValidation d) throws RemoteException, SmartFrogStateLifecycleException;
    public void deregister(RelationValidation d) throws RemoteException, SmartFrogStateLifecycleException;
}
