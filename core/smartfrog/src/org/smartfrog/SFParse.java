...
//    static String usageString = "Usage: sfParse [-v][-d] filename";
    ...
    private static void parseFiles (Vector list){
         ...
         for (int i = 0; i < list.size(); i++) {
             try {
                 ...
                 if (file.trim().length() > 0) {
                     ...
                     strb.append(
                         "-----------------------------------------------");
                     if (!opts.quiet) Logger.log(strb.toString());
                 ...
                 strb.append(
                     "-----------------------------------------------");
                 if (!opts.quiet) Logger.log(strb.toString(),thr);
             }
         }
         ...
         if (opts.statusReportHTML){
           ...
           try {
              ...
              newFile.flush();
              newFile.close();
              Logger.log("Report created: "+opts.fileName+"_report.html");
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Set stackTracing
            SFSystem.readPropertyLogStackTrace();
