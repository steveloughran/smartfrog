 ...
 */
public class SmartFrogLinkResolutionException extends
                                               SmartFrogPhaseResolutionException {
    /** String name for resolution phase. */
    { RESOLUTION_PHASE = "link resolution"; }
     ...
     */
    public SmartFrogLinkResolutionException(String message) {
        super(message);
    }
     ...
     */
    public SmartFrogLinkResolutionException (String message, Throwable cause, Reference source, Object data) {
     ...
     * @param cause exception causing this exception
     */
    public SmartFrogLinkResolutionException(Throwable cause) {
        super(cause);
    }
    ...
    public static SmartFrogException forward (Throwable thr){
        if (thr instanceof SmartFrogLinkResolutionException) {
            return (SmartFrogLinkResolutionException)thr;
        } else {
            return new SmartFrogLinkResolutionException (thr);
        }
    }
}
