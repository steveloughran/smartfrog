...
public class CoreSolver {
  ...
  public static final String CORE_SOLVER_PROPERTY
          = "org.smartfrog.sfcore.languages.sf.constraints.SolverClassName";
  public static final String ENV_SOLVER_CLASS = "SOLVERCLASS";
    ...
    try {
      try {
        if (solver == null) {
          ...
          try {
            classname = System.getProperty(CORE_SOLVER_PROPERTY);
          } catch (Exception ignored) {/*Do nothing*/}

          try {
            if (classname == null) {
              classname = System.getenv(ENV_SOLVER_CLASS);
            }
          } catch (Exception ignored) {/*Do nothing*/}
  ...
  public void tidyConstraintBasedDescription(SFComponentDescription mark)
    ...
    try {
      getOriginalDescription().visit(new CDVisitor() {
        public void actOn(ComponentDescription node, java.util.Stack path) {
          ...
          Object functionClassStatus = node.sfContext()
                  .get("sfFunctionClassStatus");
          try {
            if (functionClassStatus != null && functionClassStatus
                    .equals("done")) {
              ...
              if (functionClass
                      .equals("org.smartfrog.sfcore.languages.sf.functions.Constraint")) {
                ...
                while (attr_iter.hasNext()) {
                  node.sfContext().remove(attr_iter.next());
                }
              }
            }
          } catch (Exception sfre) {
            throw new RuntimeException(sfre);
          }
        }
      }, true);
