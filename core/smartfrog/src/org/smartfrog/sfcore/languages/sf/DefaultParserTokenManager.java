...
private final int jjStopStringLiteralDfa_0(int pos, long active0)
{
   switch (pos)
   {
      ...
      case 2:
         ...
         return -1;
      case 3:
         if ((active0 & 0x4ba400000L) != 0L)
         {
            jjmatchedKind = 35;
            jjmatchedPos = 3;
            return 5;
         }
         if ((active0 & 0x245900000L) != 0L)
            return 5;
         return -1;
      case 4:
         if ((active0 & 0x400000000L) != 0L)
            return 5;
         if ((active0 & 0xba400000L) != 0L)
         {
            jjmatchedKind = 35;
            jjmatchedPos = 4;
            return 5;
...
private final int jjMoveStringLiteralDfa2_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 79:
         return jjMoveStringLiteralDfa3_0(active0, 0x89000000L);
      case 82:
...
static final int[] jjnextStates = {
   55, 56, 61, 62, 65, 66, 30, 40, 41, 46, 47, 50, 51, 38, 24, 55, 
   56, 61, 62, 65, 66, 30, 31, 32, 40, 41, 46, 47, 50, 51, 38, 24, 
   25, 31, 33, 39, 54, 7, 8, 10, 15, 16, 18, 26, 27, 30, 34, 35, 
   38, 42, 43, 38, 50, 51, 38, 57, 58, 30, 65, 66, 30, 9, 11, 17, 
   19, 28, 29, 36, 37, 44, 45, 48, 49, 52, 53, 59, 60, 63, 64, 67, 
   68, 
};
...
"\73", "\54", "\173", "\175", "\133", "\135", "\72", "\116\125\114\114", "\55\55", 
"\145\170\164\145\156\144\163", "\114\101\132\131", "\122\117\117\124", "\101\124\124\122\111\102", 
"\124\110\111\123", "\120\122\117\120\105\122\124\131", "\111\120\122\117\120\105\122\124\131", 
"\120\101\122\105\116\124", "\110\117\123\124", "\120\122\117\103\105\123\123", 
"\43\151\156\143\154\165\144\145", "\164\162\165\145", "\146\141\154\163\145", null, null, null, null, null, null, 
...
public DefaultParserTokenManager(ASCII_UCodeESC_CharStream stream)
{
   if (ASCII_UCodeESC_CharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public DefaultParserTokenManager(ASCII_UCodeESC_CharStream stream, int lexState)
{
   this(stream);
   SwitchTo(lexState);
}
